            ...
            <div class="flex flex-col sm:flex-row gap-3">
                ...
                <form method="GET" class="w-full sm:w-auto">
                    ...
                    <input type="text" name="search" value="{{ request('search') }}"
                        ...
                        class="w-full sm:w-72 px-4 py-3 border border-gray-200 focus:outline-none focus:ring-2 focus:border-transparent transition duration-200"
                ...
                <a href="{{ route('admin.jadwal.create') }}"
                    class="inline-flex items-center justify-center px-5 py-3 text-sm font-semibold text-white shadow-sm hover:opacity-90 transition duration-200"
        ...
        <div class="bg-white border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div class="overflow-x-auto">
                ...
                <table class="min-w-full">
                    ...
                    <!-- TABLE HEAD -->
                    <thead class="border-b border-gray-100" style="background: oklch(97% 0.01 286)">
                                ...
                                <td class="px-6 py-5">
                                    ...
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <a href="{{ route('admin.jadwal.show', $item->id) }}"
                                            class="inline-flex items-center px-4 py-2 text-xs font-semibold text-white bg-blue-500 hover:bg-blue-600 transition duration-200">
                                        ...
                                        <a href="{{ route('admin.jadwal.edit', $item->id) }}"
                                            class="inline-flex items-center px-4 py-2 text-xs font-semibold text-white bg-yellow-500 hover:bg-yellow-600 transition duration-200">
                                        ...
                                        <form id="delete-form-{{ $item->id }}"
                                            ...
                                            <button type="button" onclick="confirmDelete({{ $item->id }})"
                                                class="inline-flex items-center px-4 py-2 text-xs font-semibold text-white bg-red-500 hover:bg-red-600 transition duration-200">
