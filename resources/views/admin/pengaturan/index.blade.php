        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <input type="time" name="jam_masuk_mulai"
                       value="{{ $settings['jam_masuk_mulai'] ?? '' }}"
                       class="w-full border p-3 rounded-xl">
            </div>

            <div>
                <label>Jam Masuk Akhir</label>
                <input type="time" name="jam_masuk_akhir"
                       value="{{ $settings['jam_masuk_akhir'] ?? '' }}"
                       class="w-full border p-3 rounded-xl">
            </div>
            ...
            <div>
                ...
                <input type="time" name="jam_pulang_mulai"
                       value="{{ $settings['jam_pulang_mulai'] ?? '' }}"
                       class="w-full border p-3 rounded-xl">
            </div>

            <div>
                <label>Jam Pulang Akhir</label>
                <input type="time" name="jam_pulang_akhir"
                       value="{{ $settings['jam_pulang_akhir'] ?? '' }}"
                       class="w-full border p-3 rounded-xl">
            </div>
