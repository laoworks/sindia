            ...
            <form action="{{ route('admin.kelas.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="nama_kelas" value="{{ old('nama_kelas') }}" placeholder="Contoh: X IPA 1"
                        class="w-full mt-2 px-4 py-3 border border-gray-200 focus:outline-none focus:ring-2 focus:border-transparent transition duration-200"
                ...
                <div class="flex items-center justify-end gap-3">
                    ...
                    <a href="{{ route('admin.kelas.index') }}"
                        class="inline-flex items-center px-5 py-3 text-sm font-semibold bg-gray-100 text-gray-700 hover:bg-gray-200 transition duration-200">
                    ...
                    <!-- Simpan -->
                    <button type="submit"
                        class="inline-flex items-center px-5 py-3 text-sm font-semibold text-white hover:opacity-90 transition duration-200"
