        ...
        >
            ...
            <div>
                ...
                >
                    ...
                    <option value="guru" @selected($user->role == 'guru')>
                        Guru
                    </option>
                    ...
                    <option value="kepala_sekolah" @selected($user->role == 'kepala_sekolah')>
                        Kepala Sekolah
                    </option>
            ...
            <div class="flex items-center gap-3">
                ...
                <button
                    type="submit"
                    class="px-5 py-3 rounded-lg text-white font-semibold"
