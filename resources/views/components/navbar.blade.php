    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:flex items-center gap-3">
                <a href="{{ url('/login') }}"
                   class="text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-300 px-5 lg:px-7 py-2 rounded-md shadow-sm transition duration-150 ease-in-out">
                    Login
                </a>
            </div>
    ...
    <div x-show="mobileMenuOpen"
        ...
        <div class="px-4 py-4 space-y-1">
            ...
            <a href="#home"
               ...
               class="block px-4 py-3 text-base font-medium text-gray-700 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg transition">
                Home
            </a>
            <a href="#about"
               @click="mobileMenuOpen = false"
            ...
            <div class="pt-2">
                <a href="{{ url('/login') }}"
                   @click="mobileMenuOpen = false"
                   class="block w-full px-4 py-3 text-center text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700 rounded-lg transition shadow-sm">
                    Login
                </a>
            </div>
        </div>
