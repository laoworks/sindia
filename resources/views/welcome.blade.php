...
<section id="home" class="py-16 md:py-20 bg-gradient-to-br from-indigo-50 via-white to-blue-50 scroll-animate">
 ...
 <a href="{{ url('/login') }}"
 class="bg-indigo-600 text-white px-5 py-2.5 hover:bg-indigo-700 transition text-sm md:text-base">
 Login
 </a>

 <a href="#fitur"
 class="border border-gray-300 text-gray-700 px-5 py-2.5 hover:bg-gray-50 transition text-sm md:text-base">
 Lihat Fitur
 </a>
 ...
 <div class="bg-white shadow-lg p-5 border border-gray-100 scroll-animate" data-delay="200">
 ...
 <div class="w-12 bg-indigo-200" style="height: 35px;"></div>
 <span class="text-[10px] text-gray-400">Guru</span>
 </div>
 <div class="flex flex-col items-center gap-1">
 <div class="w-12 bg-indigo-300" style="height: 55px;"></div>
 <span class="text-[10px] text-gray-400">Siswa</span>
 </div>
 <div class="flex flex-col items-center gap-1">
 <div class="w-12 bg-indigo-400" style="height: 25px;"></div>
 <span class="text-[10px] text-gray-400">Kelas</span>
 </div>
 <div class="flex flex-col items-center gap-1">
 <div class="w-12 bg-indigo-500" style="height: 45px;"></div>
...
<section id="fitur" class="py-16 bg-gray-50 border-t border-gray-100">
 ...
 <div class="bg-white border border-gray-100 p-5 shadow-sm hover:shadow-md transition scroll-animate" data-delay="0">
 ...
 <div class="bg-white border border-gray-100 p-5 shadow-sm hover:shadow-md transition scroll-animate" data-delay="100">
 ...
 <div class="bg-white border border-gray-100 p-5 shadow-sm hover:shadow-md transition scroll-animate" data-delay="200">
...
<section id="kontak" class="py-16 bg-white border-t border-gray-100 scroll-animate">
 ...
 <div class="bg-gray-50 p-5 inline-block mx-auto">
